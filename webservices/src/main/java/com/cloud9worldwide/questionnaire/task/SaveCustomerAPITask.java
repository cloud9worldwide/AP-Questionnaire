 ...
 */
public class SaveCustomerAPITask extends AsyncTask<String, Integer, String> {
    private Context context;
    private static final String debugTag = "savecustomerAPITask";
    private static final String command = "savecustomer";

    public SaveCustomerAPITask(Context context) {
