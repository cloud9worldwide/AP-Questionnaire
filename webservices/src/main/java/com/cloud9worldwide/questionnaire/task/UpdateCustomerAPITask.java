 ...
 */
public class UpdateCustomerAPITask extends AsyncTask<String, Integer, String> {
    private Context context;
    private static final String debugTag = "updatecustomerAPITask";
    private static final String command = "updatecustomer";

    public UpdateCustomerAPITask(Context context) {
