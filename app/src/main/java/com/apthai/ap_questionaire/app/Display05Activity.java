...
public class Display05Activity extends Activity implements View.OnClickListener {
    ...
    private void setImage(){
        ...
        Log.e(TAG, "url " + data.getQuestion().getImageUrl());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display05);
