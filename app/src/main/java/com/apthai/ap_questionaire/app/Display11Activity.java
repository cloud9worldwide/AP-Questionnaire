...
public class Display11Activity extends Activity implements View.OnClickListener  {
    ...
    ImageButton btnBack, btnNext, btnEN, btnTH;
...
//                progress.dismiss();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.display11, menu);
        return true;
    }
